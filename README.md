...
# Scripts
The code provided can be used to reproduce figures of the corresponding publication. Each script is named after a specific figure. Whether reproductions have identical appearance as the published figures may depend on the R version and the screen resolution. The published figures were created under R version 3.5.1 (2018-07-02) -- "Feather Spray" -- on a x86_64-w64-mingw32/x64 (64-bit) platform with 1680 x 1050 resolution.
